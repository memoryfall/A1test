...
appcan.define("listview", function(a, b, c) {
    ...
    l.prototype = {
        buildListview : function(b, c) {
            ...
            for (var h in b) {
                ...
                j[0].lv_data = b[h], j.on("tap", function(a) {
                    ...
                    e.longTapItem(a)
                }), (e.option.hasCheckbox || e.option.hasRadiobox) && ! function(a) {
                    a.find("input").on("change", function(b) {
                        a[0].lv_data.checked = b.currentTarget.checked, e.option.hasCheckbox && e.emit("checkbox:change", e, a, a[0].lv_data), e.option.hasRadiobox && e.emit("radio:change", e, a, a[0].lv_data)
                    })
                }(j), d.append(j)
            }
            var l = a(".switch", d);
        ...
        itemClick : function(b) {
            var c = this,
                d = a(b.currentTarget);
            if (d.removeClass(this.option.touchClass), c.option.hasCheckbox) {
            ...
            this.emit("click", c, d, d[0].lv_data, a(b.target))
        },
